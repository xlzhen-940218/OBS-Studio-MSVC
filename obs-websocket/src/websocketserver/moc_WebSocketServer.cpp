...
Q_CONSTINIT static const qt_meta_stringdata_CLASSWebSocketServerENDCLASS_t qt_meta_stringdata_CLASSWebSocketServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(16, 15),  // "ClientConnected"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 21),  // "WebSocketSessionState"
        QT_MOC_LITERAL(55, 5),  // "state"
        QT_MOC_LITERAL(61, 18),  // "ClientDisconnected"
        QT_MOC_LITERAL(80, 8),  // "uint16_t"
        QT_MOC_LITERAL(89, 9)   // "closeCode"
    },
    "WebSocketServer",
    "ClientConnected",
    "",
...
Q_CONSTINIT const QMetaObject WebSocketServer::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSWebSocketServerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<WebSocketSessionState, std::false_type>,
...
void WebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ClientConnected((*reinterpret_cast< std::add_pointer_t<WebSocketSessionState>>(_a[1]))); break;
        case 1: _t->ClientDisconnected((*reinterpret_cast< std::add_pointer_t<WebSocketSessionState>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint16_t>>(_a[2]))); break;
        default: ;
        }
