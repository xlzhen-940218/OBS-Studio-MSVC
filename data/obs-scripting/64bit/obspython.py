...
def obs_encoder_group_keyframe_aligned_encoders(encoder: "obs_encoder_t *", encoder_to_be_grouped: "obs_encoder_t *") -> "bool":
    r"""
    obs_encoder_group_keyframe_aligned_encoders(encoder, encoder_to_be_grouped) -> bool

    Parameters
    ----------
    encoder: obs_encoder_t *
    encoder_to_be_grouped: obs_encoder_t *

    """
    return _obspython.obs_encoder_group_keyframe_aligned_encoders(encoder, encoder_to_be_grouped)

def obs_encoder_group_remove_keyframe_aligned_encoder(encoder: "obs_encoder_t *", encoder_to_be_ungrouped: "obs_encoder_t *") -> "bool":
    r"""
    obs_encoder_group_remove_keyframe_aligned_encoder(encoder, encoder_to_be_ungrouped) -> bool

    Parameters
    ----------
    encoder: obs_encoder_t *
    encoder_to_be_ungrouped: obs_encoder_t *

    """
    return _obspython.obs_encoder_group_remove_keyframe_aligned_encoder(encoder, encoder_to_be_ungrouped)
